...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TODO: add animation line to navigation bar
        ...
        final ImageView BHGELogo = (ImageView) findViewById(R.id.bhgeAnimation);
        BHGELogo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
                               HomeActivity.this , drawer, null, R.string.navigation_drawer_open, R.string.navigation_drawer_close);
                drawer.setDrawerListener(toggle);
                toggle.syncState();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_CC) {
            //Opens the Chemical Cutter Activity when the "chemical cutter" menu is clicked.
